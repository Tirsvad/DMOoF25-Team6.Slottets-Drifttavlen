...
public class ResidentNoteConfiguration : IEntityTypeConfiguration<ResidentNote>
{
    ...
    public static void SeedingData(EntityTypeBuilder<ResidentNote> builder)
    {
        _ = builder.HasData(
            ...
            new ResidentNote { Id = Guid.Parse("E6F7A8B9-0123-4567-8901-56789ABCDE01"), ResidentId = Guid.Parse("F1A2B3C4-5678-9ABC-DEF0-12345678901"), Note = "Resident GB's note.", EditedAt = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc) },
            new ResidentNote { Id = Guid.Parse("F7A8B9C0-1234-5678-9012-6789ABCDE012"), ResidentId = Guid.Parse("F1A2B3C4-5678-9ABC-DEF0-12345678901"), Note = "Resident GB's note 2.", EditedAt = new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc) }
        );
    }
}
